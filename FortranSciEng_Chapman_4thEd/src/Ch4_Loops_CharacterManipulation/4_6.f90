! Program to calculate the equivalent day of year from a given day, month, and year.
PROGRAM doy

! Purpose: 
!       This program calculates the day of the year corresponding to a
...
!       and the SELECT CASE construct. 
        ...
        ELSE IF (MOD(year,4) == 0) THEN          ! Otherwise every 4th year is a leap year  
                leap_day = 1        
        ELSE
        ...
        DO i = 1, month-1 
               ...
               ! Add days in months form January to last month 
                SELECT CASE (i) 
